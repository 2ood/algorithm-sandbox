...
def binary_search(numberlist, target, start, end) :
    ...
    if target == numberlist[new_index] :
        ...
        return binary_search(numberlist, target, new_index,end)
    else :
        return binary_search(numberlist, target, start, new_index)
...
for i in range(int(m)) :
    print(binary_search(numberlist,targets[i],0,len(numberlist)))
